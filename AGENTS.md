...
* `playbooks/how_to_bootstrap_github_pages_jekyll_site.md` - How to create and document the GitHub Pages/Jekyll site structure, shared templates, and initial content.
* `playbooks/how_to_add_or_update_site_pages_and_blog_posts.md` - How to safely add or edit pages and blog posts while preserving shared layouts and docs consistency.
* `playbooks/how_to_verify_and_publish_github_pages_site.md` - How to verify local rendering and publish changes to GitHub Pages with the required repo hygiene steps.
